 ...
 *
 */
public class ZooKeeperHotsSession {
	
	private static CountDownLatch connectedSemaphore = new CountDownLatch(1);
	
	private ZooKeeper zookeeper;

	public ZooKeeperHotsSession() {
	...
	private static class Singleton {
		...
		private static ZooKeeperHotsSession instance;
		
		static {
			instance = new ZooKeeperHotsSession();
		}
		
		public static ZooKeeperHotsSession getInstance() {
			return instance;
		}
